                    ...
                    {options.map(option => {
                        ...
                        return (
                            <div key={option.id} className="transition-colors">
                                ...
                                {/* Expanded sub checklist builder with smooth Framer Motion height/opacity transitions */}
                                <AnimatePresence initial={false}>
                                    {isStatusTab && isExpanded && (
                                        <motion.div
                                            key={`sub-checklist-${option.id}`}
                                        ...
                                        >
                                            <div className="px-6 py-5 bg-indigo-50/20 border-t border-b border-indigo-100/40 space-y-4">
                                                ...
                                                {/* List of sub steps with transition animations */}
