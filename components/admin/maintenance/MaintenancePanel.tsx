...
import { Download, Search, Trash2, HardDrive, Archive, AlertTriangle, Loader2, RefreshCw, FileClock } from 'lucide-react';
                        ...
                        <div className="flex-1 flex flex-col justify-center animate-in zoom-in-95 relative z-10">
                            <div className="bg-red-50 p-4 rounded-2xl border border-red-100 mb-4 text-center">
                                ...
                                <div className="grid grid-cols-3 gap-2">
                                    <div>
                                        <p className="text-xl font-black text-red-600">{analysisResult.chatCount}</p>
                                        <p className="text-[10px] text-red-400">ข้อความแชท</p>
                                    </div>
                                    <div>
                                        <p className="text-xl font-black text-red-600">{analysisResult.taskCount}</p>
                                        <p className="text-[10px] text-red-400">งานที่จบแล้ว</p>
                                    </div>
                                    <div>
                                        <p className="text-xl font-black text-red-600">{analysisResult.logCount}</p>
                                        <p className="text-[10px] text-red-400">Audit Logs</p>
                                    </div>
                                </div>
                            </div>
                            <button 
