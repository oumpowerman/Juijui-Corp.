...
import { Gavel, CheckCircle, XCircle, Clock, User as UserIcon, AlertTriangle, ExternalLink, MessageSquare, ShieldAlert, Zap, Loader2 } from 'lucide-react';
        ...
        <div className="bg-white/80 backdrop-blur-xl rounded-3xl border border-white/20 shadow-xl overflow-hidden flex flex-col h-full">
            <div className="p-6 border-b border-gray-100 flex justify-between items-center bg-gradient-to-r from-indigo-50/50 to-purple-50/50">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <h3 className="font-black text-gray-800">Tribunal Review</h3>
                        <p className="text-[10px] text-gray-500 font-bold uppercase tracking-wider">ตรวจสอบคำร้องและตัดสิน</p>
                    </div>
                </div>
