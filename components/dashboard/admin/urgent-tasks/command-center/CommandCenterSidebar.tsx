        ...
        <div className="flex flex-col w-full h-full">
            ...
            {(selectedType === 'ALL' || selectedType === 'CONTENT') && (
                <div className="p-4 md:p-5 border-b border-slate-200/50">
                    ...
                    {channelsAnalytics.length === 0 ? (
                        <div className="py-4 px-3 text-center text-xs text-slate-400 font-medium bg-slate-100/70 rounded-xl border border-dashed border-slate-200">
                            ไม่มีช่องทางที่ค้างตามตัวกรองนี้
                        </div>
                    ) : (
            ...
            {(selectedType === 'ALL' || selectedType === 'TASK') && (
                <div className="p-4 md:p-5">
                    ...
                    {assigneesAnalytics.length === 0 ? (
                        <div className="py-4 px-3 text-center text-xs text-slate-400 font-medium bg-slate-100/70 rounded-xl border border-dashed border-slate-200">
                            ไม่มีบุคคลที่มีงานค้างตามตัวกรองนี้
                        </div>
                    ) : (
                        <div className="flex flex-row lg:flex-col gap-2 overflow-x-auto lg:overflow-visible pb-2 lg:pb-0 scrollbar-none">
