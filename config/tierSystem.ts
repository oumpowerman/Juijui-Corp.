...
export const getTierConfig = (hpPercent: number): TierConfig => {
    ...
    if (hpPercent >= 90) {
        return {
            ...
            borderGradient: "linear-gradient(135deg, #fbbf24 0%, #fef3c7 50%, #fbbf24 100%)",
            bannerGradient: "from-yellow-500 via-amber-400 to-yellow-500",
            glowRgb: "245, 158, 11",
            rayRgb: "251, 191, 36",
    ...
    if (hpPercent >= 80) {
        return {
            ...
            borderGradient: "linear-gradient(135deg, #94a3b8 0%, #f8fafc 50%, #94a3b8 100%)",
    ...
    if (hpPercent >= 70) {
        return {
            ...
            borderGradient: "linear-gradient(135deg, #0ea5e9 0%, #e0f2fe 50%, #0ea5e9 100%)",
    ...
    return {
        ...
        borderGradient: "linear-gradient(135deg, #6366f1 0%, #e0e7ff 50%, #6366f1 100%)",
        bannerGradient: "from-indigo-500 via-violet-400 to-indigo-500",
        glowRgb: "99, 102, 241",
        rayRgb: "99, 102, 241",
