export const DEFAULT_OPTIONS = [
    ...
    { type: 'POSITION', key: 'GRAPHIC', label: 'Graphic Designer', color: 'bg-cyan-100 text-cyan-700', sort_order: 5 },
    { type: 'POSITION', key: 'PRODUCTION', label: 'Production', color: 'bg-green-100 text-green-700', sort_order: 6 },
    { type: 'POSITION', key: 'ADMIN', label: 'Admin / Co-ord', color: 'bg-purple-100 text-purple-700', sort_order: 7 },
    { type: 'POSITION', key: 'PM', label: 'PM (Project Manager)', color: 'bg-blue-100 text-blue-800', sort_order: 8 },
    { type: 'POSITION', key: 'PA', label: 'PA (Personal Assistant)', color: 'bg-teal-100 text-teal-800', sort_order: 9 },
    { type: 'POSITION', key: 'EA', label: 'EA (Executive Assistant)', color: 'bg-purple-100 text-purple-800', sort_order: 10 },
    { type: 'POSITION', key: 'AE', label: 'AE (Account Executive)', color: 'bg-rose-100 text-rose-800', sort_order: 11 },
